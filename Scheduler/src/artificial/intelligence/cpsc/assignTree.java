...
public class assignTree {
	...
	public float evaluateThis(Classes course, TimeSlot time)
	{
		...
		if(!lc.doAllChecks(parser.getCourses(),parser.getNonCompatible(),parser.getUnwanted(),parser.getFiveHundredCourses(),parser.getEveningCourses(),parser.getEveningLabs())){
